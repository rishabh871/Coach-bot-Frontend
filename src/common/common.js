//  export const BASE_URL = "https://api.ideationsolutions.net/"
//  export const origin = "https://api.ideationsolutions.net/"
// export const BASE_URL = "https://api.furever-pet.com";
...
export const setUserRole = (val) => localStorage.setItem("user", val);
export const setUserId = (val) => localStorage.setItem("userId", val);
export const setEmailLocal = (val) => localStorage.setItem("email", val);
export const setWallet = (val) => localStorage.setItem("wallet", val);

export const getToken = () => localStorage.getItem("token");
export const getWallet = () => localStorage.getItem("wallet");
export const getUserId = (val) => localStorage.getItem("user_id");
export const getEmail = (val) => localStorage.getItem("email");

export const getBusdContract = "0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee";
